...
//palette
 ...
 }else if ((mouseX>=1000+(200/3)+(200/3) && mouseX<=1200) && (mouseY>=0 && mouseY<=50)) {
     brushClr= '#FFC432';//orange yellow
 }else if ((mouseX>=1000 && mouseX<=1000+(200/3)) && (mouseY>50 && mouseY<=100)) {
     brushClr= '#FFFF00';//yellow
   }else if ((mouseX>=1000+(200/3) && mouseX<=1000+(200/3)+(200/3)) && (mouseY>50 && mouseY<=100)) {
     brushClr= '#CFE12C';//yellow green
 }else if ((mouseX>=1000+(200/3)+(200/3) && mouseX<=1200) && (mouseY>50 && mouseY<=100)) {
     brushClr= '#008037';//green
 }else if ((mouseX>=1000 && mouseX<=1000+(200/3)) && (mouseY>100 && mouseY<=150)) {
     brushClr= '#0101FD';//blue
   }else if ((mouseX>=1000+(200/3) && mouseX<=1000+(200/3)+(200/3)) && (mouseY>100 && mouseY<=150)) {
     brushClr= '#4401A5';//indigo
 }else if ((mouseX>=1000+(200/3)+(200/3) && mouseX<=1200) && (mouseY>100 && mouseY<=150)) {
     brushClr= '#8C00B1';//violet
 }else if ((mouseX>=1000 && mouseX<=1000+(200/3)) && (mouseY>150 && mouseY<=200)) {
     brushClr= 255;//white
   }else if ((mouseX>=1000+(200/3) && mouseX<=1000+(200/3)+(200/3)) && (mouseY>150 && mouseY<=200)) {
     brushClr= 150;//gray
 }else if ((mouseX>=1000+(200/3)+(200/3) && mouseX<=1200) && (mouseY>150 && mouseY<=200)) {
     brushClr= 0;//black
 }
 }
//slider bar
